...
\capa{Fundamentos Teóricos de Mecânica Quântica 123}{Lucas R. Ximenes}{Felipe Gimenez S.}{Alexandre A. Suaide}
...
\part{Fundamentos básicos}
    ...
    \chapter{\hspace{0.8cm}Introdução à mecânica quântica}
        \input{Partes/Parte 2/Capítulos/Introdução I}
    
        \section{Espaço de Hilbert}
            \input{Partes/Parte 2/Capítulos/Seções/Espaço de Hilbert}
        
            \subsection{Base ortonormal em um espaço vetorial euclidiano}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Base ortonormal em um espaço vetorial euclidiano.tex}

            \subsection{Notação de Dirac e o espaço de bra-kets}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Notação de Dirac e o espaço de bra-kets}

            \subsection{Definição do espaço de Hilbert}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Definição do espaço de Hilbert}
        ...
        \section{Mudança de base}
            \input{Partes/Parte 2/Capítulos/Seções/Mudança de base}

        \section{Operadores em Mecânica Quântica}
            \input{Partes/Parte 2/Capítulos/Seções/Operadores em MQ}

            \subsection{Medidas em Mecânica Quântica}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Medidas em MQ}
        
            \subsection{Operadores hermitianos}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Operadores hermitianos}

            \subsection{Medidas simultâneas}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/Medidas simultâneas}

        \section{Operadores de posição e momento}
            \input{Partes/Parte 2/Capítulos/Seções/Operadores de posição e momento}

            \subsection{O operador de posição}
                \input{Partes/Parte 2/Capítulos/Seções/Subseções/O operador de posição}
...
\part{Fundamentos Avançados}
    ...
    \chapter{\hspace{0.8cm}Mecânica quântica relativística}
        \input{Partes/Parte 4/Capítulos/Mecânica quântica relativística}

        \section{Sistemas de unidades naturais}
            \input{Partes/Parte 4/Capítulos/Seções/Sistemas de unidades naturais}

        \section{Recordando relatividade restrita}
            \input{Partes/Parte 4/Capítulos/Seções/Recordando relatividade restrita}

            \subsection{Transformações de Lorentz}
                \input{Partes/Parte 4/Capítulos/Seções/Subseções/Subsubseções/Transformações de Lorentz}

        \section{A equação de Klein--Fock--Gordon}
            \input{Partes/Parte 4/Capítulos/Seções/A equação de Klein-Fock-Gordon}

        \section{A equação de Dirac}
            \input{Partes/Parte 4/Capítulos/Seções/A equação de Dirac}
